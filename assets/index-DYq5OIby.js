...
`;function Ma({icon:c,title:f,count:d,children:o}){return n.jsxs("div",{className:"adm-panel",children:[n.jsxs("div",{className:"adm-panel-head",children:[n.jsx("span",{children:c}),n.jsx("h3",{children:f}),d!==void 0&&n.jsx("span",{className:"adm-panel-badge",children:d})]}),n.jsx("div",{className:"adm-panel-body",children:o})]})}function xv(){const c=oo(),[f,d]=S.useState("overview"),[o,m]=S.useState(""),[h,v]=S.useState(""),[T,j]=S.useState(""),[g,M]=S.useState([]),[A,B]=S.useState([]),[X,$]=S.useState([]),[V,q]=S.useState([]),[R,H]=S.useState([]),[L,ie]=S.useState(null),[be,ze]=S.useState(""),[ee,Re]=S.useState(""),[Ae,oa]=S.useState(!0),[Je,Fe]=S.useState(localStorage.getItem("brochureName")||""),[la,na]=S.useState(null),[Sa,D]=S.useState(!1),[Y,I]=S.useState([]),[se,he]=S.useState({name:"",role:"",message:"",img:""}),[y,k]=S.useState(!1),[G,Q]=S.useState([]),[F,te]=S.useState({name:"",subject:"",experience:"",img:""}),[pe,Ke]=S.useState(!1),[ye,et]=S.useState([]),[ia,at]=S.useState({name:"",achievement:"",year:"",img:""}),[oi,Ja]=S.useState(!1),[ce,Le]=S.useState({name:"",role:"Principal",photo:"/principal.jpg",qualification:"",experience:"",joined:"",school:"Sarvodaya Vidyalaya",message:"",quote:"",stat1num:"25+",stat1label:"Years Experience",stat2num:"5000+",stat2label:"Students Guided",stat3num:"100%",stat3label:"Board Results",stat4num:"30+",stat4label:"Awards Won"}),[Ds,cn]=S.useState(!1),[Ce,ua]=S.useState({phone:"",email:"",address:"",city:"",officeHours:"Mon – Sat, 8:00 AM – 2:30 PM",facebookUrl:"",twitterUrl:"",instagramUrl:"",whatsappNum:"",mapSrc:"https://www.google.com/maps?q=Hingna,Nagpur,Maharashtra&output=embed"}),[on,ui]=S.useState(!1),Rs=window.location.hostname==="localhost"?"http://localhost:5000":"https://svv-school-backend.onrender.com";S.useEffect(()=>{const b=()=>{Re(new Date().toLocaleTimeString("en-IN",{hour:"2-digit",minute:"2-digit"}))};b();const K=setInterval(b,1e3);return()=>clearInterval(K)},[]),S.useEffect(()=>{localStorage.getItem("adminAuth")||c("/admin"),M(JSON.parse(localStorage.getItem("notices"))||[]),B(JSON.parse(localStorage.getItem("events"))||[]),$(JSON.parse(localStorage.getItem("academics"))||[]),H(JSON.parse(localStorage.getItem("gallery"))||[]);const b=JSON.parse(localStorage.getItem("managementList")||"[]");b.length>0&&I(b);const K=JSON.parse(localStorage.getItem("teacherList")||"[]");K.length>0&&Q(K);const Ue=JSON.parse(localStorage.getItem("successList")||"[]");Ue.length>0&&et(Ue);const Be=JSON.parse(localStorage.getItem("principalInfo")||"{}");Object.keys(Be).length>0&&Le(lt=>({...lt,...Be}));const ha=JSON.parse(localStorage.getItem("contactInfo")||"{}");Object.keys(ha).length>0&&ua(lt=>({...lt,...ha}));const ra=localStorage.getItem("newsAlertEnabled");ra!==null&&oa(ra==="true")},[c]),S.useEffect(()=>{fetch(`${Rs}/api/admissions`).then(b=>b.json()).then(b=>q(b)).catch(b=>console.log(b))},[]);const sa=()=>{if(!o.trim())return;const b=[...g,o.trim()];M(b),localStorage.setItem("notices",JSON.stringify(b)),m(""),window.dispatchEvent(new Event("noticesUpdated"))},_s=b=>{const K=g.filter((Ue,Be)=>Be!==b);M(K),localStorage.setItem("notices",JSON.stringify(K)),window.dispatchEvent(new Event("noticesUpdated"))},un=(b,K,Ue,Be,ha)=>{if(!b.trim())return;const ra=[...K,b.trim()];Ue(ra),localStorage.setItem(Be,JSON.stringify(ra)),ha("")},dn=(b,K,Ue,Be)=>{const ha=K.filter((ra,lt)=>lt!==b);Ue(ha),localStorage.setItem(Be,JSON.stringify(ha))},Wt=()=>un(h,A,B,"events",v),di=()=>un(T,X,$,"academics",j),fi=b=>dn(b,A,B,"events"),Us=b=>dn(b,X,$,"academics"),mi=()=>{const b=!Ae;oa(b),localStorage.setItem("newsAlertEnabled",String(b)),window.dispatchEvent(new Event("newsAlertToggled"))},Ft=()=>{if(!L)return;const b=new FileReader;b.onloadend=()=>{const K=[...R,b.result];H(K),localStorage.setItem("gallery",JSON.stringify(K)),ie(null)},b.readAsDataURL(L)},da=b=>{const K=R.filter((Ue,Be)=>Be!==b);H(K),localStorage.setItem("gallery",JSON.stringify(K))},Ka=()=>{if(!la){alert("Please select a PDF file first.");return}if(la.size>4*1024*1024){alert("PDF is too large (max 4MB). Please compress it and try again."),na(null);return}const b=la,K=new FileReader;K.onloadend=()=>{try{const Ue=K.result;if(!Ue||Ue.length<100){alert("File read failed. Please try again.");return}localStorage.setItem("brochureData",Ue),localStorage.setItem("brochureName",b.name),Fe(b.name),na(null),D(!0),setTimeout(()=>D(!1),3e3),setTimeout(()=>{window.dispatchEvent(new Event("brochureUpdated"))},100)}catch{alert("Upload failed: PDF is too large for browser storage. Please use a smaller PDF (under 4MB)."),na(null)}},K.onerror=()=>{alert("Could not read the file. Please try again."),na(null)},K.readAsDataURL(b)},fa=()=>{localStorage.removeItem("brochureData"),localStorage.removeItem("brochureName"),Fe(""),na(null),setTimeout(()=>{window.dispatchEvent(new Event("brochureUpdated"))},100)},ks=()=>{if(!se.name.trim()||!se.role.trim())return;const b=[...Y,{...se}];I(b),localStorage.setItem("managementList",JSON.stringify(b)),he({name:"",role:"",message:"",img:""}),k(!0),setTimeout(()=>k(!1),3e3)},Hs=b=>{const K=Y.filter((Ue,Be)=>Be!==b);I(K),localStorage.setItem("managementList",JSON.stringify(K))},Ls=()=>{if(!F.name.trim()||!F.subject.trim())return;const b=[...G,{...F}];Q(b),localStorage.setItem("teacherList",JSON.stringify(b)),te({name:"",subject:"",experience:"",img:""}),Ke(!0),setTimeout(()=>Ke(!1),3e3)},vl=b=>{const K=G.filter((Ue,Be)=>Be!==b);Q(K),localStorage.setItem("teacherList",JSON.stringify(K))},bl=()=>{if(!ia.name.trim()||!ia.achievement.trim())return;const b=[...ye,{...ia}];et(b),localStorage.setItem("successList",JSON.stringify(b)),at({name:"",achievement:"",year:"",img:""}),Ja(!0),setTimeout(()=>Ja(!1),3e3)},xl=b=>{const K=ye.filter((Ue,Be)=>Be!==b);et(K),localStorage.setItem("successList",JSON.stringify(K))},tt=()=>{localStorage.setItem("principalInfo",JSON.stringify(ce)),cn(!0),setTimeout(()=>cn(!1),3e3)},yl=()=>{localStorage.setItem("contactInfo",JSON.stringify(Ce)),ui(!0),setTimeout(()=>ui(!1),3e3)},It=()=>{localStorage.removeItem("adminAuth"),c("/admin")},Bs=()=>{const K=`Name,Email,Phone,Stream,Message
`+V.map(ra=>`"${ra.name}","${ra.email}","${ra.phone}","${ra.stream||""}","${ra.message||""}"`).join(`
`),Ue=new Blob([K],{type:"text/csv"}),Be=window.URL.createObjectURL(Ue),ha=document.createElement("a");ha.href=Be,ha.download="admissions.csv",ha.click()},jl=V.filter(b=>b.name?.toLowerCase().includes(be.toLowerCase())),fn=[{id:"overview",icon:"📊",label:"Overview"},{id:"news",icon:"📢",label:"News & Alerts",badge:g.length},{id:"events",icon:"📅",label:"Events",badge:A.length},{id:"academics",icon:"📚",label:"Academics",badge:X.length},{id:"gallery",icon:"🖼️",label:"Gallery",badge:R.length},{id:"brochure",icon:"📄",label:"Brochure"},{id:"admissions",icon:"🎓",label:"Admissions",badge:V.length},{id:"principal",icon:"👩‍💼",label:"Principal"},{id:"contact",icon:"📍",label:"Contact"},{id:"management",icon:"👔",label:"Management",badge:Y.length},{id:"teachers",icon:"🧑‍🏫",label:"Teachers",badge:G.length},{id:"success",icon:"🏆",label:"Success Stories",badge:ye.length}];return n.jsxs(n.Fragment,{children:[n.jsx("style",{children:bv}),n.jsxs("div",{className:"adm-wrap",children:[n.jsxs("div",{className:"adm-topbar",children:[n.jsxs("div",{className:"adm-topbar-left",children:[n.jsx("div",{className:"adm-logo-box",children:"SVK"}),n.jsxs("div",{children:[n.jsx("div",{className:"adm-topbar-title",children:"Admin Dashboard"}),n.jsx("div",{className:"adm-topbar-sub",children:"Sarvodaya Vidyalaya"})]})]}),n.jsxs("div",{className:"adm-topbar-right",children:[n.jsxs("span",{className:"adm-time",children:["🕐 ",ee]}),n.jsx("button",{className:"adm-logout-btn",onClick:It,children:"⬠ Logout"})]})]}),n.jsxs("div",{className:"adm-layout",children:[n.jsxs("div",{className:"adm-sidebar",children:[n.jsx("div",{className:"adm-sidebar-section",children:"Navigation"}),fn.map(b=>n.jsxs("button",{className:`adm-tab-btn ${f===b.id?"active":""}`,onClick:()=>d(b.id),children:[n.jsx("span",{className:"adm-tab-icon",children:b.icon}),b.label,b.badge!==void 0&&b.badge>0&&n.jsx("span",{className:"adm-tab-badge",children:b.badge})]},b.id)),n.jsxs("div",{className:"adm-sidebar-stats",children:[n.jsxs("div",{className:"adm-sidebar-stat",children:[n.jsx("span",{children:"Total Items"}),n.jsx("strong",{children:g.length+A.length+X.length+R.length})]}),n.jsxs("div",{className:"adm-sidebar-stat",children:[n.jsx("span",{children:"Admissions"}),n.jsx("strong",{children:V.length})]}),n.jsxs("div",{className:"adm-sidebar-stat",children:[n.jsx("span",{children:"News Ticker"}),n.jsx("strong",{style:{color:Ae?"#68d391":"#fc8181"},children:Ae?"ON":"OFF"})]})]})]}),n.jsxs("div",{className:"adm-content",children:[f==="overview"&&n.jsxs("div",{children:[n.jsx("div",{className:"adm-tab-header",children:n.jsxs("div",{className:"adm-tab-header-left",children:[n.jsx("div",{className:"adm-tab-label",children:"Dashboard"}),n.jsx("div",{className:"adm-tab-title",children:"Overview"})]})}),n.jsx("div",{className:"adm-overview-grid",children:[{icon:"📢",label:"Notices",num:g.length,hint:"Click to manage",tab:"news"},{icon:"📅",label:"Events",num:A.length,hint:"Click to manage",tab:"events"},{icon:"📚",label:"Academics",num:X.length,hint:"Click to manage",tab:"academics"},{icon:"🖼️",label:"Gallery",num:R.length,hint:"Click to manage",tab:"gallery"},{icon:"🎓",label:"Admissions",num:V.length,hint:"Click to view",tab:"admissions"},{icon:"👔",label:"Management",num:Y.length,hint:"Click to manage",tab:"management"},{icon:"🧑‍🏫",label:"Teachers",num:G.length,hint:"Click to manage",tab:"teachers"},{icon:"🏆",label:"Success",num:ye.length,hint:"Click to manage",tab:"success"}].map(b=>n.jsxs("div",{className:"adm-ov-card",onClick:()=>d(b.tab),children:[n.jsx("div",{className:"adm-ov-icon",children:b.icon}),n.jsxs("div",{children:[n.jsx("div",{className:"adm-ov-num",children:b.num}),n.jsx("div",{className:"adm-ov-label",children:b.label}),n.jsxs("div",{className:"adm-ov-hint",children:[b.hint," →"]})]})]},b.label))}),n.jsxs("div",{className:"adm-grid-2",style:{marginTop:"8px"},children:[n.jsx(Ma,{icon:"🔔",title:"News Ticker Status",count:Ae?"ON":"OFF",children:n.jsxs("div",{style:{display:"flex",alignItems:"center",justifyContent:"space-between",gap:"14px"},children:[n.jsx("span",{style:{color:"var(--muted)",fontSize:"0.88rem"},children:Ae?"Visitors currently see the scrolling news ticker.":"The news ticker is hidden from the website."}),n.jsx("button",{className:Ae?"adm-btn-del":"adm-btn-gold",onClick:mi,style:{minWidth:"110px"},children:Ae?"Turn Off":"Turn On"})]})}),n.jsxs(Ma,{icon:"📄",title:"Brochure Status",count:Je?"Uploaded":"None",children:[n.jsx("div",{style:{fontSize:"0.88rem",color:"var(--muted)"},children:Je?n.jsxs("span",{style:{color:"var(--success)",fontWeight:600},children:["📄 ",Je," — Live on navbar"]}):"No brochure uploaded. Go to the Brochure tab to upload a PDF."}),n.jsx("button",{className:"adm-btn-gold",onClick:()=>d("brochure"),style:{marginTop:"12px",fontSize:"0.78rem",padding:"7px 14px"},children:"Manage Brochure →"})]})]})]}),f==="news"&&n.jsxs("div",{children:[n.jsxs("div",{className:"adm-tab-header",children:[n.jsxs("div",{className:"adm-tab-header-left",children:[n.jsx("div",{className:"adm-tab-label",children:"Content"}),n.jsx("div",{className:"adm-tab-title",children:"News & Alerts"})]}),n.jsxs("button",{className:Ae?"adm-btn-del":"adm-btn-gold",onClick:mi,style:{minWidth:"130px"},children:["Ticker: ",Ae?"ON — Turn Off":"OFF — Turn On"]})]}),n.jsxs(Ma,{icon:"📢",title:"News Ticker Items",count:g.length,children:[n.jsxs("div",{className:"adm-input-row",children:[n.jsx("input",{className:"adm-input",type:"text",placeholder:"Enter news item...",value:o,onChange:b=>m(b.target.value),onKeyDown:b=>b.key==="Enter"&&sa()}),n.jsx("button",{className:"adm-btn-add",onClick:sa,children:"+ Add"})]}),n.jsx("p",{style:{marginBottom:"12px",color:"var(--muted)",fontSize:"0.84rem"},children:"These messages appear in the scrolling ticker at the top of the public site."}),n.jsxs("ul",{className:"adm-list",children:[g.length===0&&n.jsx("div",{className:"adm-list-empty",children:"No news items yet"}),g.map((b,K)=>n.jsxs("li",{className:"adm-list-item",children:[n.jsx("span",{children:b}),n.jsx("button",{className:"adm-btn-del",onClick:()=>_s(K),children:"✕"})]},K))]})]})]}),f==="events"&&n.jsxs("div",{children:[n.jsx("div",{className:"adm-tab-header",children:n.jsxs("div",{className:"adm-tab-header-left",children:[n.jsx("div",{className:"adm-tab-label",children:"Content"}),n.jsx("div",{className:"adm-tab-title",children:"Events"})]})}),n.jsxs(Ma,{icon:"📅",title:"Events",count:A.length,children:[n.jsxs("div",{className:"adm-input-row",children:[n.jsx("input",{className:"adm-input",type:"text",placeholder:"Enter event...",value:h,onChange:b=>v(b.target.value),onKeyDown:b=>b.key==="Enter"&&Wt()}),n.jsx("button",{className:"adm-btn-add",onClick:Wt,children:"+ Add"})]}),n.jsxs("ul",{className:"adm-list",children:[A.length===0&&n.jsx("div",{className:"adm-list-empty",children:"No events yet"}),A.map((b,K)=>n.jsxs("li",{className:"adm-list-item",children:[n.jsx("span",{children:b}),n.jsx("button",{className:"adm-btn-del",onClick:()=>fi(K),children:"✕"})]},K))]})]})]}),f==="academics"&&n.jsxs("div",{children:[n.jsx("div",{className:"adm-tab-header",children:n.jsxs("div",{className:"adm-tab-header-left",children:[n.jsx("div",{className:"adm-tab-label",children:"Content"}),n.jsx("div",{className:"adm-tab-title",children:"Academics"})]})}),n.jsxs(Ma,{icon:"📚",title:"Academics",count:X.length,children:[n.jsxs("div",{className:"adm-input-row",children:[n.jsx("input",{className:"adm-input",type:"text",placeholder:"Enter academic info...",value:T,onChange:b=>j(b.target.value),onKeyDown:b=>b.key==="Enter"&&di()}),n.jsx("button",{className:"adm-btn-add",onClick:di,children:"+ Add"})]}),n.jsxs("ul",{className:"adm-list",children:[X.length===0&&n.jsx("div",{className:"adm-list-empty",children:"No items yet"}),X.map((b,K)=>n.jsxs("li",{className:"adm-list-item",children:[n.jsx("span",{children:b}),n.jsx("button",{className:"adm-btn-del",onClick:()=>Us(K),children:"✕"})]},K))]})]})]}),f==="gallery"&&n.jsxs("div",{children:[n.jsx("div",{className:"adm-tab-header",children:n.jsxs("div",{className:"adm-tab-header-left",children:[n.jsx("div",{className:"adm-tab-label",children:"Media"}),n.jsx("div",{className:"adm-tab-title",children:"Gallery"})]})}),n.jsxs(Ma,{icon:"🖼️",title:"Gallery",count:R.length,children:[n.jsxs("label",{className:"adm-file-zone",children:[n.jsx("input",{type:"file",accept:"image/*",onChange:b=>ie(b.target.files[0])}),n.jsx("span",{className:"adm-file-zone-label",children:L?n.jsxs("span",{className:"adm-file-selected",children:["✅ ",L.name]}):n.jsxs(n.Fragment,{children:[n.jsx("strong",{children:"Click to choose"})," an image to upload"]})})]}),n.jsx("button",{className:"adm-btn-gold",onClick:Ft,disabled:!L,style:{opacity:L?1:.5,cursor:L?"pointer":"not-allowed",marginBottom:"8px"},children:"⬆ Upload Image"}),n.jsxs("div",{className:"adm-gallery-grid",children:[R.length===0&&n.jsx("div",{style:{gridColumn:"1/-1",textAlign:"center",padding:"30px",color:"var(--muted)",fontSize:"0.83rem"},children:"No images uploaded yet"}),R.map((b,K)=>n.jsxs("div",{className:"adm-gallery-item",children:[n.jsx("img",{src:b,alt:`gallery-${K}`}),n.jsx("button",{className:"adm-gallery-del",onClick:()=>da(K),children:"✕"})]},K))]})]})]}),f==="brochure"&&n.jsxs("div",{children:[n.jsx("div",{className:"adm-tab-header",children:n.jsxs("div",{className:"adm-tab-header-left",children:[n.jsx("div",{className:"adm-tab-label",children:"Media"}),n.jsx("div",{className:"adm-tab-title",children:"School Brochure"})]})}),n.jsxs(Ma,{icon:"📄",title:"Download Brochure — activates the navbar button",count:Je?"Uploaded":"None",children:[n.jsxs("p",{style:{color:"var(--muted)",fontSize:"0.85rem",marginBottom:"14px"},children:["Upload a PDF here. Once uploaded, the ",n.jsx("strong",{style:{color:"var(--navy)"},children:"Download Brochure"})," button in the navbar becomes active for visitors."]}),n.jsxs("label",{className:"adm-file-zone",children:[n.jsx("input",{type:"file",accept:"application/pdf",onChange:b=>na(b.target.files[0])}),n.jsx("span",{className:"adm-file-zone-label",children:la?n.jsxs("span",{className:"adm-file-selected",children:["✅ ",la.name]}):n.jsxs(n.Fragment,{children:[n.jsx("strong",{children:"Click to choose"})," a PDF brochure to upload"]})})]}),n.jsxs("div",{style:{display:"flex",gap:"10px",alignItems:"center",flexWrap:"wrap"},children:[n.jsx("button",{className:"adm-btn-gold",onClick:Ka,disabled:!la,style:{opacity:la?1:.5,cursor:la?"pointer":"not-allowed"},children:"⬆ Upload Brochure"}),Je&&n.jsx("button",{className:"adm-btn-del",onClick:fa,children:"✕ Remove"}),Sa&&n.jsx("span",{className:"adm-save-badge",children:"✅ Uploaded! Navbar button is now active."})]}),Je?n.jsxs("div",{className:"adm-brochure-active",children:[n.jsx("div",{className:"adm-brochure-icon",children:"📄"}),n.jsxs("div",{className:"adm-brochure-info",children:[n.jsx("div",{className:"adm-brochure-name",children:Je}),n.jsx("div",{className:"adm-brochure-hint",children:"✅ Live — visitors can download from the navbar"})]})]}):n.jsx("div",{className:"adm-brochure-none",children:"No brochure uploaded yet — navbar button will appear dimmed."})]})]}),f==="admissions"&&n.jsxs("div",{children:[n.jsxs("div",{className:"adm-tab-header",children:[n.jsxs("div",{className:"adm-tab-header-left",children:[n.jsx("div",{className:"adm-tab-label",children:"Students"}),n.jsx("div",{className:"adm-tab-title",children:"Admission Requests"})]}),n.jsx("button",{className:"adm-btn-gold",onClick:Bs,children:"⬇ Export CSV"})]}),n.jsxs(Ma,{icon:"🎓",title:"Admission Requests",count:jl.length,children:[n.jsx("div",{className:"adm-search-row",children:n.jsx("input",{className:"adm-input",type:"text",placeholder:"🔍  Search student by name...",value:be,onChange:b=>ze(b.target.value)})}),n.jsx("div",{className:"adm-table-wrap",children:n.jsxs("table",{className:"adm-table",children:[n.jsx("thead",{children:n.jsxs("tr",{children:[n.jsx("th",{children:"#"}),n.jsx("th",{children:"Name"}),n.jsx("th",{children:"Email"}),n.jsx("th",{children:"Phone"}),n.jsx("th",{children:"Stream"}),n.jsx("th",{children:"Message"})]})}),n.jsx("tbody",{children:jl.length===0?n.jsx("tr",{children:n.jsx("td",{colSpan:"6",style:{textAlign:"center",padding:"28px",color:"var(--muted)"},children:"No admission requests found"})}):jl.map((b,K)=>n.jsxs("tr",{children:[n.jsx("td",{className:"muted",children:K+1}),n.jsx("td",{children:n.jsx("strong",{children:b.name})}),n.jsx("td",{className:"muted",children:b.email}),n.jsx("td",{className:"muted",children:b.phone}),n.jsx("td",{children:b.stream?n.jsx("span",{className:"stream-badge",children:b.stream}):n.jsx("span",{style:{color:"var(--muted)"},children:"—"})}),n.jsx("td",{children:b.message||n.jsx("span",{style:{color:"var(--muted)"},children:"—"})})]},K))})]})})]})]}),f==="principal"&&n.jsxs("div",{children:[n.jsxs("div",{className:"adm-tab-header",children:[n.jsxs("div",{className:"adm-tab-header-left",children:[n.jsx("div",{className:"adm-tab-label",children:"Staff"}),n.jsx("div",{className:"adm-tab-title",children:"Principal Info"})]}),n.jsxs("div",{style:{display:"flex",gap:"10px",alignItems:"center"},children:[Ds&&n.jsx("span",{className:"adm-save-badge",children:"✅ Saved!"}),n.jsx("button",{className:"adm-btn-gold",onClick:tt,children:"💾 Save Changes"})]})]}),n.jsxs(Ma,{icon:"👩‍💼",title:"Principal Info — reflects on /principal page",children:[n.jsxs("div",{className:"adm-field-row-2",children:[n.jsxs("div",{className:"adm-field-group",children:[n.jsx("label",{className:"adm-field-label",children:"Full Name"}),n.jsx("input",{className:"adm-input",placeholder:"Dr. Sunita Sharma",value:ce.name,onChange:b=>Le({...ce,name:b.target.value})})]}),n.jsxs("div",{className:"adm-field-group",children:[n.jsx("label",{className:"adm-field-label",children:"Role / Title"}),n.jsx("input",{className:"adm-input",placeholder:"Principal",value:ce.role,onChange:b=>Le({...ce,role:b.target.value})})]})]}),n.jsxs("div",{className:"adm-field-row-2",children:[n.jsxs("div",{className:"adm-field-group",children:[n.jsx("label",{className:"adm-field-label",children:"Qualification"}),n.jsx("input",{className:"adm-input",placeholder:"M.Sc., B.Ed., Ph.D.",value:ce.qualification,onChange:b=>Le({...ce,qualification:b.target.value})})]}),n.jsxs("div",{className:"adm-field-group",children:[n.jsx("label",{className:"adm-field-label",children:"Experience"}),n.jsx("input",{className:"adm-input",placeholder:"25+ Years",value:ce.experience,onChange:b=>Le({...ce,experience:b.target.value})})]})]}),n.jsxs("div",{className:"adm-field-row-2",children:[n.jsxs("div",{className:"adm-field-group",children:[n.jsx("label",{className:"adm-field-label",children:"Joined Since"}),n.jsx("input",{className:"adm-input",placeholder:"Since 2010",value:ce.joined,onChange:b=>Le({...ce,joined:b.target.value})})]}),n.jsxs("div",{className:"adm-field-group",children:[n.jsx("label",{className:"adm-field-label",children:"Photo Path"}),n.jsx("input",{className:"adm-input",placeholder:"/principal.jpg",value:ce.photo,onChange:b=>Le({...ce,photo:b.target.value})})]})]}),n.jsxs("div",{className:"adm-field-group",children:[n.jsx("label",{className:"adm-field-label",children:"Message"}),n.jsx("textarea",{className:"adm-input",style:{minHeight:"120px"},placeholder:"Write the principal's message here...",value:ce.message,onChange:b=>Le({...ce,message:b.target.value})})]}),n.jsxs("div",{className:"adm-field-group",children:[n.jsx("label",{className:"adm-field-label",children:"Highlight Quote"}),n.jsx("input",{className:"adm-input",placeholder:"Education is not the filling of a pail...",value:ce.quote,onChange:b=>Le({...ce,quote:b.target.value})})]}),n.jsx("div",{className:"adm-field-label",style:{marginBottom:"10px"},children:"Achievement Stats"}),n.jsxs("div",{className:"adm-field-row-2",children:[n.jsxs("div",{className:"adm-field-group",children:[n.jsx("label",{className:"adm-field-label",children:"Stat 1 Number"}),n.jsx("input",{className:"adm-input",placeholder:"25+",value:ce.stat1num,onChange:b=>Le({...ce,stat1num:b.target.value})})]}),n.jsxs("div",{className:"adm-field-group",children:[n.jsx("label",{className:"adm-field-label",children:"Stat 1 Label"}),n.jsx("input",{className:"adm-input",placeholder:"Years Experience",value:ce.stat1label,onChange:b=>Le({...ce,stat1label:b.target.value})})]})]}),n.jsxs("div",{className:"adm-field-row-2",children:[n.jsxs("div",{className:"adm-field-group",children:[n.jsx("label",{className:"adm-field-label",children:"Stat 2 Number"}),n.jsx("input",{className:"adm-input",placeholder:"5000+",value:ce.stat2num,onChange:b=>Le({...ce,stat2num:b.target.value})})]}),n.jsxs("div",{className:"adm-field-group",children:[n.jsx("label",{className:"adm-field-label",children:"Stat 2 Label"}),n.jsx("input",{className:"adm-input",placeholder:"Students Guided",value:ce.stat2label,onChange:b=>Le({...ce,stat2label:b.target.value})})]})]}),n.jsxs("div",{className:"adm-field-row-2",children:[n.jsxs("div",{className:"adm-field-group",children:[n.jsx("label",{className:"adm-field-label",children:"Stat 3 Number"}),n.jsx("input",{className:"adm-input",placeholder:"100%",value:ce.stat3num,onChange:b=>Le({...ce,stat3num:b.target.value})})]}),n.jsxs("div",{className:"adm-field-group",children:[n.jsx("label",{className:"adm-field-label",children:"Stat 3 Label"}),n.jsx("input",{className:"adm-input",placeholder:"Board Results",value:ce.stat3label,onChange:b=>Le({...ce,stat3label:b.target.value})})]})]}),n.jsxs("div",{className:"adm-field-row-2",children:[n.jsxs("div",{className:"adm-field-group",children:[n.jsx("label",{className:"adm-field-label",children:"Stat 4 Number"}),n.jsx("input",{className:"adm-input",placeholder:"30+",value:ce.stat4num,onChange:b=>Le({...ce,stat4num:b.target.value})})]}),n.jsxs("div",{className:"adm-field-group",children:[n.jsx("label",{className:"adm-field-label",children:"Stat 4 Label"}),n.jsx("input",{className:"adm-input",placeholder:"Awards Won",value:ce.stat4label,onChange:b=>Le({...ce,stat4label:b.target.value})})]})]})]})]}),f==="contact"&&n.jsxs("div",{children:[n.jsxs("div",{className:"adm-tab-header",children:[n.jsxs("div",{className:"adm-tab-header-left",children:[n.jsx("div",{className:"adm-tab-label",children:"Settings"}),n.jsx("div",{className:"adm-tab-title",children:"Contact Info"})]}),n.jsxs("div",{style:{display:"flex",gap:"10px",alignItems:"center"},children:[on&&n.jsx("span",{className:"adm-save-badge",children:"✅ Saved!"}),n.jsx("button",{className:"adm-btn-gold",onClick:yl,children:"💾 Save Changes"})]})]}),n.jsxs(Ma,{icon:"📍",title:"Contact Info — reflects on /contact page",children:[n.jsxs("div",{className:"adm-field-row-2",children:[n.jsxs("div",{className:"adm-field-group",children:[n.jsx("label",{className:"adm-field-label",children:"Phone Number"}),n.jsx("input",{className:"adm-input",placeholder:"+91 98765 43210",value:Ce.phone,onChange:b=>ua({...Ce,phone:b.target.value})})]}),n.jsxs("div",{className:"adm-field-group",children:[n.jsx("label",{className:"adm-field-label",children:"Email Address"}),n.jsx("input",{className:"adm-input",placeholder:"info@sarvodayavk.edu.in",value:Ce.email,onChange:b=>ua({...Ce,email:b.target.value})})]})]}),n.jsxs("div",{className:"adm-field-row-2",children:[n.jsxs("div",{className:"adm-field-group",children:[n.jsx("label",{className:"adm-field-label",children:"Address"}),n.jsx("input",{className:"adm-input",placeholder:"Hingna Road, Near Main Bus Stop",value:Ce.address,onChange:b=>ua({...Ce,address:b.target.value})})]}),n.jsxs("div",{className:"adm-field-group",children:[n.jsx("label",{className:"adm-field-label",children:"City / District"}),n.jsx("input",{className:"adm-input",placeholder:"Hingna, Nagpur – 441110",value:Ce.city,onChange:b=>ua({...Ce,city:b.target.value})})]})]}),n.jsxs("div",{className:"adm-field-group",children:[n.jsx("label",{className:"adm-field-label",children:"Office Hours"}),n.jsx("input",{className:"adm-input",placeholder:"Mon – Sat, 8:00 AM – 2:30 PM",value:Ce.officeHours,onChange:b=>ua({...Ce,officeHours:b.target.value})})]}),n.jsx("div",{className:"adm-field-label",style:{marginBottom:"10px"},children:"Social Media Links"}),n.jsxs("div",{className:"adm-field-row-2",children:[n.jsxs("div",{className:"adm-field-group",children:[n.jsx("label",{className:"adm-field-label",children:"Facebook URL"}),n.jsx("input",{className:"adm-input",placeholder:"https://facebook.com/yourpage",value:Ce.facebookUrl,onChange:b=>ua({...Ce,facebookUrl:b.target.value})})]}),n.jsxs("div",{className:"adm-field-group",children:[n.jsx("label",{className:"adm-field-label",children:"Twitter / X URL"}),n.jsx("input",{className:"adm-input",placeholder:"https://twitter.com/yourpage",value:Ce.twitterUrl,onChange:b=>ua({...Ce,twitterUrl:b.target.value})})]})]}),n.jsxs("div",{className:"adm-field-row-2",children:[n.jsxs("div",{className:"adm-field-group",children:[n.jsx("label",{className:"adm-field-label",children:"Instagram URL"}),n.jsx("input",{className:"adm-input",placeholder:"https://instagram.com/yourpage",value:Ce.instagramUrl,onChange:b=>ua({...Ce,instagramUrl:b.target.value})})]}),n.jsxs("div",{className:"adm-field-group",children:[n.jsx("label",{className:"adm-field-label",children:"WhatsApp Number"}),n.jsx("input",{className:"adm-input",placeholder:"919876543210",value:Ce.whatsappNum,onChange:b=>ua({...Ce,whatsappNum:b.target.value})})]})]}),n.jsxs("div",{className:"adm-field-group",children:[n.jsx("label",{className:"adm-field-label",children:"Google Maps Embed URL"}),n.jsx("input",{className:"adm-input",placeholder:"https://www.google.com/maps?q=...&output=embed",value:Ce.mapSrc,onChange:b=>ua({...Ce,mapSrc:b.target.value})})]})]})]}),f==="management"&&n.jsxs("div",{children:[n.jsx("div",{className:"adm-tab-header",children:n.jsxs("div",{className:"adm-tab-header-left",children:[n.jsx("div",{className:"adm-tab-label",children:"Staff"}),n.jsx("div",{className:"adm-tab-title",children:"Management Team"})]})}),n.jsxs(Ma,{icon:"👔",title:"Management Team — reflects on /management page",count:Y.length,children:[n.jsxs("div",{className:"adm-field-row-2",children:[n.jsxs("div",{className:"adm-field-group",children:[n.jsx("label",{className:"adm-field-label",children:"Full Name"}),n.jsx("input",{className:"adm-input",placeholder:"Dr. A. Deshmukh",value:se.name,onChange:b=>he({...se,name:b.target.value})})]}),n.jsxs("div",{className:"adm-field-group",children:[n.jsx("label",{className:"adm-field-label",children:"Role / Title"}),n.jsx("input",{className:"adm-input",placeholder:"Chairman",value:se.role,onChange:b=>he({...se,role:b.target.value})})]})]}),n.jsxs("div",{className:"adm-field-group",children:[n.jsx("label",{className:"adm-field-label",children:"Message / Quote"}),n.jsx("textarea",{className:"adm-input",placeholder:"Our vision is to provide quality education...",value:se.message,onChange:b=>he({...se,message:b.target.value})})]}),n.jsxs("div",{className:"adm-field-group",children:[n.jsx("label",{className:"adm-field-label",children:"Photo URL"}),n.jsx("input",{className:"adm-input",placeholder:"https://randomuser.me/api/portraits/men/11.jpg",value:se.img,onChange:b=>he({...se,img:b.target.value})})]}),n.jsxs("div",{className:"adm-save-row",children:[y&&n.jsx("span",{className:"adm-save-badge",children:"✅ Member added!"}),n.jsx("button",{className:"adm-btn-gold",onClick:ks,children:"+ Add Member"})]}),Y.length>0?n.jsx("ul",{className:"adm-list",style:{marginTop:"16px"},children:Y.map((b,K)=>n.jsxs("li",{className:"adm-list-item",children:[b.img&&n.jsx("img",{src:b.img,alt:b.name,style:{width:36,height:36,borderRadius:"50%",objectFit:"cover",flexShrink:0}}),n.jsxs("span",{children:[n.jsx("strong",{children:b.name})," — ",b.role]}),n.jsx("button",{className:"adm-btn-del",onClick:()=>Hs(K),children:"✕"})]},K))}):n.jsx("div",{className:"adm-list-empty",children:"No management members added yet"})]})]}),f==="teachers"&&n.jsxs("div",{children:[n.jsx("div",{className:"adm-tab-header",children:n.jsxs("div",{className:"adm-tab-header-left",children:[n.jsx("div",{className:"adm-tab-label",children:"Staff"}),n.jsx("div",{className:"adm-tab-title",children:"Teachers"})]})}),n.jsxs(Ma,{icon:"🧑‍🏫",title:"Teachers — reflects on /teachers page",count:G.length,children:[n.jsxs("div",{className:"adm-field-row-2",children:[n.jsxs("div",{className:"adm-field-group",children:[n.jsx("label",{className:"adm-field-label",children:"Full Name"}),n.jsx("input",{className:"adm-input",placeholder:"Mr. Rajesh Sharma",value:F.name,onChange:b=>te({...F,name:b.target.value})})]}),n.jsxs("div",{className:"adm-field-group",children:[n.jsx("label",{className:"adm-field-label",children:"Subject"}),n.jsx("input",{className:"adm-input",placeholder:"Mathematics",value:F.subject,onChange:b=>te({...F,subject:b.target.value})})]})]}),n.jsxs("div",{className:"adm-field-row-2",children:[n.jsxs("div",{className:"adm-field-group",children:[n.jsx("label",{className:"adm-field-label",children:"Experience"}),n.jsx("input",{className:"adm-input",placeholder:"10+ Years",value:F.experience,onChange:b=>te({...F,experience:b.target.value})})]}),n.jsxs("div",{className:"adm-field-group",children:[n.jsx("label",{className:"adm-field-label",children:"Photo URL"}),n.jsx("input",{className:"adm-input",placeholder:"https://randomuser.me/api/portraits/men/32.jpg",value:F.img,onChange:b=>te({...F,img:b.target.value})})]})]}),n.jsxs("div",{className:"adm-save-row",children:[pe&&n.jsx("span",{className:"adm-save-badge",children:"✅ Teacher added!"}),n.jsx("button",{className:"adm-btn-gold",onClick:Ls,children:"+ Add Teacher"})]}),G.length>0?n.jsx("ul",{className:"adm-list",style:{marginTop:"16px"},children:G.map((b,K)=>n.jsxs("li",{className:"adm-list-item",children:[b.img&&n.jsx("img",{src:b.img,alt:b.name,style:{width:36,height:36,borderRadius:"50%",objectFit:"cover",flexShrink:0}}),n.jsxs("span",{children:[n.jsx("strong",{children:b.name})," — ",b.subject," · ",b.experience]}),n.jsx("button",{className:"adm-btn-del",onClick:()=>vl(K),children:"✕"})]},K))}):n.jsx("div",{className:"adm-list-empty",children:"No teachers added yet"})]})]}),f==="success"&&n.jsxs("div",{children:[n.jsx("div",{className:"adm-tab-header",children:n.jsxs("div",{className:"adm-tab-header-left",children:[n.jsx("div",{className:"adm-tab-label",children:"Content"}),n.jsx("div",{className:"adm-tab-title",children:"Success Stories"})]})}),n.jsxs(Ma,{icon:"🏆",title:"Success Stories — reflects on /success page",count:ye.length,children:[n.jsxs("div",{className:"adm-field-row-2",children:[n.jsxs("div",{className:"adm-field-group",children:[n.jsx("label",{className:"adm-field-label",children:"Student Name"}),n.jsx("input",{className:"adm-input",placeholder:"Rahul Verma",value:ia.name,onChange:b=>at({...ia,name:b.target.value})})]}),n.jsxs("div",{className:"adm-field-group",children:[n.jsx("label",{className:"adm-field-label",children:"Year"}),n.jsx("input",{className:"adm-input",placeholder:"2025",value:ia.year,onChange:b=>at({...ia,year:b.target.value})})]})]}),n.jsxs("div",{className:"adm-field-row-2",children:[n.jsxs("div",{className:"adm-field-group",children:[n.jsx("label",{className:"adm-field-label",children:"Achievement"}),n.jsx("input",{className:"adm-input",placeholder:"Selected in IIT Bombay",value:ia.achievement,onChange:b=>at({...ia,achievement:b.target.value})})]}),n.jsxs("div",{className:"adm-field-group",children:[n.jsx("label",{className:"adm-field-label",children:"Photo URL"}),n.jsx("input",{className:"adm-input",placeholder:"https://randomuser.me/api/portraits/men/12.jpg",value:ia.img,onChange:b=>at({...ia,img:b.target.value})})]})]}),n.jsxs("div",{className:"adm-save-row",children:[oi&&n.jsx("span",{className:"adm-save-badge",children:"✅ Story added!"}),n.jsx("button",{className:"adm-btn-gold",onClick:bl,children:"+ Add Story"})]}),ye.length>0?n.jsx("ul",{className:"adm-list",style:{marginTop:"16px"},children:ye.map((b,K)=>n.jsxs("li",{className:"adm-list-item",children:[b.img&&n.jsx("img",{src:b.img,alt:b.name,style:{width:36,height:36,borderRadius:"50%",objectFit:"cover",flexShrink:0}}),n.jsxs("span",{children:[n.jsx("strong",{children:b.name})," — ",b.achievement," ",n.jsxs("span",{style:{color:"var(--gold)",fontWeight:600},children:["(",b.year,")"]})]}),n.jsx("button",{className:"adm-btn-del",onClick:()=>xl(K),children:"✕"})]},K))}):n.jsx("div",{className:"adm-list-empty",children:"No success stories added yet"})]})]})]})]})]})]})}function yv(){return n.jsxs(k0,{children:[n.jsx(Z0,{}),n.jsxs("div",{style:{paddingTop:"104px"},children:[n.jsx(F0,{}),n.jsxs(f0,{children:[n.jsx(Ya,{path:"/",element:n.jsx(lv,{})}),n.jsx(Ya,{path:"/about",element:n.jsx(nv,{})}),n.jsx(Ya,{path:"/academics",element:n.jsx(iv,{})}),n.jsx(Ya,{path:"/gallery",element:n.jsx(sv,{})}),n.jsx(Ya,{path:"/contact",element:n.jsx(cv,{})}),n.jsx(Ya,{path:"/teachers",element:n.jsx(uv,{})}),n.jsx(Ya,{path:"/management",element:n.jsx(fv,{})}),n.jsx(Ya,{path:"/success",element:n.jsx(hv,{})}),n.jsx(Ya,{path:"/principal",element:n.jsx(pv,{})}),n.jsx(Ya,{path:"/admin",element:n.jsx(vv,{})}),n.jsx(Ya,{path:"/admin-dashboard",element:n.jsx(xv,{})})]})]}),n.jsx($0,{}),n.jsx(K0,{})]})}pg.createRoot(document.getElementById("root")).render(n.jsx(ro.StrictMode,{children:n.jsx(yv,{})}));
